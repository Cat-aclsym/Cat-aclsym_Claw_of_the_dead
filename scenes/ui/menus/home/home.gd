...
@onready var levels_menu: PackedScene = preload("res://scenes/ui/menus/level_selection/level_selection.tscn")
@onready var option_menu: PackedScene =  preload("res://scenes/ui/menus/options/options.tscn")
