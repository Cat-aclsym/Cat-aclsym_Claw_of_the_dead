...
var is_accumulative: bool = false
...
var _hue: float = 0.0
var _tween: Tween
var _relative_offset: Vector2 = Vector2.ZERO
...
func _update_visuals() -> void:
	var rounded_amount: float = amount
...
func _start_animation() -> void:
	...
	var base_scale: Vector2 = Vector2.ONE * (1.2 if is_critical else 0.8)
	var bounce_scale: Vector2 = base_scale * 1.5
...
func _trigger_bounce() -> void:
	...
	_tween = create_tween()
	var base_scale: Vector2 = Vector2.ONE * (1.2 if is_critical else 0.8)
	var bounce_scale: Vector2 = base_scale * 1.1
