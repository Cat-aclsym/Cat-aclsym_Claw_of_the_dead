...
func build_state(state_id: String, state_callback: Callable = func(): pass) -> StateMachineBuilder:
...
func build_initial_state(state_id: String, state_callback: Callable = func(): pass) -> StateMachineBuilder:
	var state := StateFactory.create(state_id, state_callback)
